...
public class ProductControllerV1pt1 {
    ...
    @ApiOperation(value = "절약 목록 조회 API(1.1 Ver)", notes = "절약 리스트를 조회할 때 사용되는 API입니다")
    @ApiResponses(value ={
    ...
    @ApiOperation(value = "절약 등록 API(1.1 Ver)", notes = "절약 리스트에 새로운 절약을 등록하여 추가할 때 사용되는 API입니다")
    @ApiResponses(value ={
